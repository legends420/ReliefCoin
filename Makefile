...
pkgdatadir = $(datadir)/reliefcoin
pkgincludedir = $(includedir)/reliefcoin
pkglibdir = $(libdir)/reliefcoin
pkglibexecdir = $(libexecdir)/reliefcoin
...
CONFIG_HEADER = $(top_builddir)/src/config/reliefcoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/reliefcoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = reliefcoin-cli
BITCOIN_DAEMON_NAME = cryptonodesd
BITCOIN_GUI_NAME = reliefcoin-qt
BITCOIN_TX_NAME = reliefcoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = reliefcoin
PACKAGE_BUGREPORT = www.reliefcoin.ch
PACKAGE_NAME = Reliefcoin Core
PACKAGE_STRING = Reliefcoin Core 1.3.0
PACKAGE_TARNAME = reliefcoin
PACKAGE_URL = 
...
abs_builddir = /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master
abs_srcdir = /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master
abs_top_builddir = /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master
abs_top_srcdir = /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/legends/Desktop/CoinForks/ReliefCoinv2/reliefcoin-core-master/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_cryptonodes_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_cryptonodes_coverage.info test_cryptonodes.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Reliefcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/reliefcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/reliefcoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/reliefcoin-config.h
$(top_srcdir)/src/config/reliefcoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/reliefcoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Reliefcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Reliefcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Reliefcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_cryptonodes.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_cryptonodes -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_cryptonodes_filtered.info: test_cryptonodes.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_cryptonodes_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_cryptonodes_coverage.info: baseline_filtered_combined.info test_cryptonodes_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cryptonodes_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_cryptonodes_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cryptonodes_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_cryptonodes.coverage/.dirstamp:  test_cryptonodes_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_cryptonodes.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_cryptonodes.coverage/ total.coverage/ $(OSX_APP)
