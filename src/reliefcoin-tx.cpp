...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Reliefcoin Core reliefcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  reliefcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded reliefcoin transaction") + "\n" +
                               "  reliefcoin-tx [options] -create [commands]   " + _("Create hex-encoded reliefcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded reliefcoin transaction
