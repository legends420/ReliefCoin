                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Reliefcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TGAO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reliefcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Reliefcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Reliefcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Reliefcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TGAO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TGAO addresses"));
    ...
    openAction->setStatusTip(tr("Open a reliefcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Reliefcoin Core help message to get a list with possible Reliefcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Reliefcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Reliefcoin network", "", count));
}
...
{
    QString strTitle = tr("Reliefcoin Core"); // default title
