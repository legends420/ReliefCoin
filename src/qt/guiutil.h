...
/** Utility functions used by the Reliefcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TGAO addresses in monospace font
...
// Parse "reliefcoin:" URI into recipient object, return true on successful parsing
