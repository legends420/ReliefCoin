/* src/config/reliefcoin-config.h.  Generated from reliefcoin-config.h.in by configure.  */
/* src/config/reliefcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.reliefcoin.ch"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Reliefcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Reliefcoin Core 1.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "reliefcoin"
