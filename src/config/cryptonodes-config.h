/* src/config/cryptonodes-config.h.  Generated from cryptonodes-config.h.in by configure.  */
/* src/config/cryptonodes-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CNMC_CONFIG_H

#define CNMC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cryptonodes.ch"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cryptonodes Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cryptonodes Core 1.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cryptonodes"
