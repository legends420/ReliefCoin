...
In order to support loading of multiple wallets in cryptonodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptonodes.cpp.
...
Changes to cryptonodes.cpp
----------------------
cryptonodes.cpp is the entry point into cryptonodes-qt, and as such, will require some minor modifications to provide hooks for
